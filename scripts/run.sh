...
soot_path="/home/cs17b006/stava-master/soot/sootclasses-trunk-jar-with-dependencies.jar"

# Path to stava repository
stava_path="/home/cs17b006/stava-master"

# The directory to be analysed.
test_path="/home/cs17b006/stava-master/tests/test26"

main_class_name="Main"

# The directory inside which stava will output the results.
output_path="/home/cs17b006/stava-master/output_dir/test26"
...
$java_vm -Xmx10g -classpath $soot_path:${stava_path}/src main.Main $java_install_path false $test_path $main_class_name $output_path
